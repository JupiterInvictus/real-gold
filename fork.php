...
$application_version_major = "2017-07-12";
$application_version_minor = "08:50";
...
function displayvmbox($dvm_team, $dvm_metric, $dvm_value) {
  ...
  // Target title
  echo "<span class='targettitle xtoggle' style='color:#$fg'>tgt</span>";
  // Target area
    ...
    if ($a) {
      ...
      echo "<div id='area_body'>";
			...
			if($a=='seating'){
				...
				echo "ASSIGN: ";
				echo "team: <select id='assignteam'>";
				...
				echo "</select> / ";
				echo "person: <select id='assignperson'>";
				echo "</select>";
				...
				for ($h = 1; $h <= $height; $h++) {
					...
					for ($w = 1; $w <= $width; $w++) {
						...
						echo "<td class='$seatclass' id='seat-$w-$h'></td>\n";
					}
					echo "</tr>";
				}
			}
			...
			if($a=='bonus'){
				if ($team>0){
					echo "<a href='?a=oldbonus&b=e&startdate=$startdate&enddate=$enddate&team=$team'>Old bonus</a>";
					if (ismgr()){
      ...
      echo "</div>";
			echo "<div class='z-button showextra' onClick='toggleShowExtra();'>toggle crap</div>";
    }
	}
}
if ($forked) {
